...
class DecompressorPlugin(var enabled : Boolean, var pipelined : Boolean) extends Plugin{
  ...
  val logic = create late new Area{
    ...
    import stage._
    val ways = for(i <- 0 until DECODE_COUNT) new Area {
...
object RvcDecompressor{
  ...
  def apply(i : Bits, rvf : Boolean, rvd : Boolean): DecompressedInstruction ={
    ...
    switch(i(1 downto 0) ## i(15 downto 13)){
      ...
      if(rvf) is(3){ret.inst := lwImm ## rch ##  B"010" ## rcl ## B"0000111"} // C.FLW
      ...
      if(rvf) is(7){ret.inst := swImm(11 downto 5) ## rcl  ## rch ## B"010" ## swImm(4 downto 0) ## B"0100111"} // C.FSW
      is(8){ret.inst := addImm ## i(11 downto 7) ## B"000" ## i(11 downto 7) ## B"0010011"} //C.ADDI -> addi rd, rd, nzimm[5:0].
      is(9){ret.inst := jalImm(20) ## jalImm(10 downto 1) ## jalImm(11) ## jalImm(19 downto 12) ## x1 ## B"1101111"} //C.JAL -> jalr x1, rs1, 0.
      ...
      is(16){ ret.inst := B"0000000" ## i(6 downto 2) ## i(11 downto 7) ## B"001" ## i(11 downto 7) ## B"0010011"   }
      ...
      if(rvf) is(19){ret.inst := lwspImm ## x2 ## B"010" ## i(11 downto 7) ## B"0000111" } // C.FLWSP
      is(20) {
      ...
      if(rvf) is(23){ret.inst := swspImm(11 downto 5) ## i(6 downto 2)  ## x2 ## B"010" ## swspImm(4 downto 0) ## B"0100111" } // C.FSwSP
    }
